...
/**
     ...
     * @return string
     */
    public function buildQueryWithoutEncode($params) {
       return CurlController::buildQuery($params, false);
    }

    public function buildQueryWithEncode($params){
        return CurlController::buildQuery($params, true);
    }
    ...
    public static function buildQuery($params, $needEncode){
        ...
        foreach ($params as $k => $v) {
            if (false === CurlController::checkEmpty($v)) {
                if($needEncode){
                    $v = urlencode($v);
                }
