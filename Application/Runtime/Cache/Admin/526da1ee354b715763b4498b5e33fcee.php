                            ...
                            <!--数据start-->
                                <tr>
                                   <td>
									...
									<td>
										<?php echo ($data["d_nums"]); ?>
									</td>
									<td>
										<?php echo (sprintf("%.2f",$data["d_money"])); ?> 元
									</td>
									<td>
										<?php echo ($data["dh_nums"]); ?>
									</td>
									<td>
										<?php echo (sprintf("%.2f",$data["dh_money"])); ?> 元
									</td>
									<td>
										<?php echo ($data["w_nums"]); ?>
									</td>
									<td>
										<?php echo (sprintf("%.2f",$data["w_money"])); ?> 元
									</td>
									<td>
										<?php echo (sprintf("%.2f",$data["dk_money"])); ?> 元
									</td>
                                </tr>
                    ...
                    series: [
                        {
                            name: '当日逾期笔数',
                            type: 'bar',
                            data: [<?php echo ($data["yu_day_nums"]); ?>],
                            markPoint: {
                                data: [
                                    {type: 'max', name: '最大值'},
                                    {type: 'min', name: '最小值'}
