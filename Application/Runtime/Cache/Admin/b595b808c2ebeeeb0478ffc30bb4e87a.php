...
<div class="navbar navbar-default" id="navbar">
    <script type="text/javascript">
        ...
        $(function () {
            ...
            var maxTime = <?php echo nl_get_customConfig('overtime')*60;?>; // seconds
            var time = maxTime;
            if(maxTime>0){
                ...
                function ShowInvalidLoginMessage(){
                    ...
                    // 提示用户
                    // 该干嘛干嘛
                    window.location="<?php echo U('Public/over');?>";
                }
                ...
                <li class="light-blue">
                    <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                        ...
                        <span class="user-info">
									<small>欢迎光临,</small>
									<?php echo ($_SESSION['NorthCMS_AdminUser']['username']); ?>
								</span>
    ...
    <div class="main-container-inner">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <ul class="nav nav-list">
                ...
                <li class="active">
                    <a href="<?php echo U('Index/main');?>" target="main">
                ...
                <li>
                    <?php if(is_array($menu)): $i = 0; $__LIST__ = $menu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="#" class="dropdown-toggle">
                        ...
                        <ul class="submenu">
                            <?php if(is_array($vo["children"])): $i = 0; $__LIST__ = $vo["children"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li>
                                    <a href="<?php echo ($v["href"]); ?>" target="main">
        ...
        <div class="main-content" style="height: 1200px">
            <div class="breadcrumbs" id="breadcrumbs">
                ...
                <iframe name="main" src="<?php echo U('Index/main');?>" frameborder="0" width="100%" height="100%">
                </iframe>
