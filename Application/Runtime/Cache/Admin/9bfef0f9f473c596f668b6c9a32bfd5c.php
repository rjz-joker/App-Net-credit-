...
<div class="layui-tab">
    ...
    <div class="">
        <div class="col-md-6">
            <?php if(authCheck('Admin/Category/add',session(C('ADMIN_INFO'))['id'])): ?><a href="<?php echo U('Category/add');?>" class="btn btn-success">添加分类</a><?php endif; ?>
        </div>
        ...
        <table class="layui-table" lay-skin="line">
            ...
            <?php if(is_array($model)): foreach($model as $key=>$v): ?><tr>
                    ...
                    <td>
                        <?php if(authCheck('Admin/Category/update',session(C('ADMIN_INFO'))['id'])): ?><a href="<?php echo U('Category/update',array('id'=>$v['id']));?>">编辑</a> |<?php endif; ?>

                        <?php if(authCheck('Admin/Category/delete',session(C('ADMIN_INFO'))['id'])): ?><a href="<?php echo U('Category/delete',array('id'=>$v['id']));?>" style="color:red;"
