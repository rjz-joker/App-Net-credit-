...
class LLpaySubmit {
	...
	function LLpaySubmit($llpay_config,$llpay_gateway_new) {
		$this->__construct($llpay_config,$llpay_gateway_new);
	}
    ...
    function buildRequestJSON($para_temp,$llpay_gateway_new) {
        ...
        file_put_contents("log1.txt","请求:".$request_data."\n", FILE_APPEND);
	 ...
	 */
	 function buildRequestForm($para_temp, $method, $button_name) {
		//待请求参数数组
		$para = $this->buildRequestPara2($para_temp);
