...
$xu_day=nl_get_customConfig("xu_day");
$xu_money=nl_get_customConfig("xu_money");
$price =$xu_day*$xu_money*100;

$order_name = "续期".$xu_day."天";
$order_id = $_SESSION["oid"];

$notify_b = "http://yzj.ynwad.com/notify2.php?order_id2=".$order_id."";
		...
		WeixinJSBridge.invoke(
			...
			function(res){
				...
				if(res.err_msg == "get_brand_wcpay_request:ok"){
                   alert('支付成功！');
                    window.location.href="http://yzj.ynwad.com/Home/Loan/lists";
